	...
	?>
            ...
            <table border="0" cellspacing="0" cellpadding="5">
              ...
              for($i=0; $i<$arResult["FIELDS"]["COUNT"]; $i++){
				...
				elseif(strpos($arResult["FIELDS"][$i]["TITLE"], "College") === false && $arResult["FIELDS"][$i]["TITLE"] != "Alternative email" && $arResult["FIELDS"][$i]["TITLE"] != "Table" && $arResult["FIELDS"][$i]["TITLE"] != "Hall" && $arResult["FIELDS"][$i]["TITLE"] != "Priority destinations"){
			  	?>
