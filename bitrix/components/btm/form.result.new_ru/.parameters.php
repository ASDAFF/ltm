...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"STEP" => array(
			"NAME" => GetMessage("COMP_FORM_PARAMS_STEP"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
			"PARENT" => "FORM_PARAMS",
		),
		...
		"REGIST_USER" => array(
			"NAME" => GetMessage("COMP_FORM_PARAMS_REGIST_USER"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
			"PARENT" => "FORM_PARAMS",
		),
		...
		"REGIST_GROUP" => array(
			"NAME" => GetMessage("COMP_FORM_PARAMS_REGIST_GROUP"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
			"PARENT" => "FORM_PARAMS",
		),
		...
		"LOGIN_FIELD" => array(
			"NAME" => GetMessage("COMP_FORM_PARAMS_LOGIN_FIELD"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
			"PARENT" => "FORM_PARAMS",
		),
		...
		"PASS_FIELD" => array(
			"NAME" => GetMessage("COMP_FORM_PARAMS_PASS_FIELD"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
			"PARENT" => "FORM_PARAMS",
		),
		...
		"EMAIL_FIELD" => array(
			"NAME" => GetMessage("COMP_FORM_PARAMS_EMAIL_FIELD"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
			"PARENT" => "FORM_PARAMS",
		),
		...
		"CHECK_LOGIN" => array(
			"NAME" => GetMessage("COMP_FORM_PARAMS_CHECK_LOGIN"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
			"PARENT" => "FORM_PARAMS",
		),

		"SECOND_FORM_ID" => array(
			"NAME" => GetMessage("COMP_FORM_PARAMS_SECOND_FORM"),
			"TYPE" => "LIST",
			"VALUES" => $arrForms,
			"ADDITIONAL_VALUES"	=> "Y",
			"DEFAULT" => "={\$_REQUEST[WEB_FORM_ID]}",
