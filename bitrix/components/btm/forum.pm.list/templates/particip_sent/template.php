...
?>
        <tr>
            ...
            <td>
            <a href="/cabinet/service/only_read.php?mes=<?=$res["ID"]?>" target="_blank" onclick="newWind('/cabinet/service/only_read.php?mes=<?=$res["ID"]?>'); return false;">
            <?=$res["POST_SUBJ"]?>
            </a>
          </td>
            <td class="company"><?=$res["SHOW_COMPANY"]?></td>
            <td><?=$res["SHOW_NAME"]?></td>
