			...
			)
			{
				...
				if (check_bitrix_sessid())
				{
					$return = false;					
                     ...
                     if(isset($_REQUEST["form_text_10"]) && $_REQUEST["form_text_10"] != ''){
						$userTmp = new CUser;
						$arTmpUsFields = Array(
						  "EMAIL"             => strtolower($_REQUEST["form_email_19"]),
						  "NAME"	          => $_REQUEST["form_text_1"],
						  "LAST_NAME"         => $_REQUEST["form_text_2"],
						  "WORK_COMPANY"      => $_REQUEST["form_text_10"],
						);
						$userTmp->Update($_REQUEST["id"], $arTmpUsFields);
						$strError .= $userTmp->LAST_ERROR;
					}
					elseif(isset($_REQUEST["form_text_130"]) && $_REQUEST["form_text_130"] != ''){
						$userTmp = new CUser;
						$arTmpUsFields = Array(
						  "EMAIL"             => strtolower($_REQUEST["form_email_159"]),
						  "NAME"	          => $_REQUEST["form_text_128"],
						  "LAST_NAME"         => $_REQUEST["form_text_129"],
						  "WORK_COMPANY"      => $_REQUEST["form_text_130"],
						  "PASSWORD"          => $_REQUEST["form_password_168"],
						  "CONFIRM_PASSWORD"  => $_REQUEST["form_password_168"],
						  "ADMIN_NOTES"       => $_REQUEST["form_password_168"],
						);
						$userTmp->Update($_REQUEST["id"], $arTmpUsFields);
						$strError .= $userTmp->LAST_ERROR;
					}
...
/*---------------------------------------------------*/
//     ÔÎÐÌÈÐÓÅÌ ÂÛÂÎÄ ÏÎËÜÇÎÂÀÒÅËÜÑÊÈÕ ÏÎËÅÉ        //
/*---------------------------------------------------*/
