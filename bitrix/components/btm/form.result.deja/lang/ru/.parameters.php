...
$MESS ['COMP_FORM_PARAMS_EMAIL_FIELD'] = "Поле Email для логина";
$MESS ['COMP_FORM_PARAMS_ANKETA_TO'] = "Поле куда записываем id формы.";
$MESS ['COMP_FORM_PARAMS_ANKETA_FROM'] = "Поле откуда берем id формы с данными.";
?>