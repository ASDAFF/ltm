...
<form action="" method="post">
	<?switch($arParams["ACT"]):
		...
		<?case "morning":?>		
			...
			<a class="custom-buttom" href="/ajax/all_pdf_shedule.php?type=guest&app=<?=$arResult["EXHIB"]["CODE"]?>" class="go" data-hb="" data-to="shedule">PDF расписания</a>
			<a class="custom-buttom" href="/ajax/all_pdf_wishlist.php?type=guest&app=<?=$arResult["EXHIB"]["CODE"]?>" class="go" data-hb="" data-to="wishlist">PDF вишлисты</a>
		...
		<?case "hostbuy":?>
			...
			<a class="custom-buttom" href="/ajax/all_pdf_shedule.php?type=guest&app=<?=$arResult["EXHIB"]["CODE"]?>&hb=y" class="go" data-hb="y" data-to="shedule">PDF HB расписания</a>
			<a class="custom-buttom" href="/ajax/all_pdf_wishlist.php?type=guest&app=<?=$arResult["EXHIB"]["CODE"]?>&hb=y" class="go" data-hb="y" data-to="wishlist">PDF HB вишлисты</a>
			<? /*<input class="custom-buttom" type="button" name="edit" disabled value="Редактировать">$arParams["EXHIBIT_CODE"]
			<input class="custom-buttom" type="button" name="generate-schedule" disabled value="Генерировать расписание">
			<input class="custom-buttom" type="button" name="generate-wishlist" disabled value="Генерировать вишлист">
			<input class="custom-buttom unconfirm-participate-button-mass" type="button" name="unconfirm" value="Отправить в Неподтвержденные">
