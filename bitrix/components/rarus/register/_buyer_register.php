...
$arUserFormFields = array(
		...
		"form_text_222" => $webAddress,									//веб сайт
		...
		case "361" ://Москва, Россия. 13 марта 2014
			{
				if(!empty($morning))
				{
					$eventName[] = "REG_NEW_B_MOSSP_M";
				}
				if(!empty($evening))
				{
					$eventName[] = "REG_NEW_B_MOSSP_E";
				}
			}
		break;
		case "357" ://Баку, Азербайджан. 10 апреля 2014
			{
				if(!empty($morning))
				{
					$eventName[] = "REG_NEW_B_BAK_M";
				}
				if(!empty($evening))
				{
					$eventName[] = "REG_NEW_B_BAK_E";
				}
			}
		break;
		case "360" ://Киев, Украина. 23 сентября 2014	
			{
				if(!empty($morning))
				{
					$eventName[] = "REG_NEW_B_KIEV_M";
				}
				if(!empty($evening))
				{
					$eventName[] = "REG_NEW_B_KIEV_E";
				}
			}
		break;
		case "488" ://Москва, Россия. 12-13 марта 2015	
			{
				if(!empty($morning))
				{
					$eventName[] = "REG_NEW_B_MOSSP15_M";
				}
				if(!empty($evening))
				{
					$eventName[] = "REG_NEW_B_MOSSP15_E";
				}
			}
		break;
		case "358" ://Москва, Россия. 2 октября 2014	
			{
				if(!empty($morning))
				{
					$eventName[] = "REG_NEW_B_MOSOT_M";
				}
				if(!empty($evening))
				{
					$eventName[] = "REG_NEW_B_MOSOT_E";
				}
			}
		break;
		case "359" ://Алматы, Казахстан. 26 сентября 2014
			{
				if(!empty($morning))
				{
					$eventName[] = "REG_NEW_B_ALM_M";
				}
				if(!empty($evening))
				{
					$eventName[] = "REG_NEW_B_ALM_E";
				}
			}
		break;
}
