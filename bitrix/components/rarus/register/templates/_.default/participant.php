...
<div class="registr_exh">
	...
	<div class="some-information">
		...
		<div class="block-company">
			...
			<?= ShowText("SIMPLE_QUESTION_988","COMPANY_NAME", $arResult["COMPANY_FORM"], "require");?>
			<?/*Official name for invoice*/?>
			<div class="dropdown-title">Official name for invoice</div>
			<?= ShowText("SIMPLE_QUESTION_106","COMPANY_NAME_FOR_INVOICE", $arResult["COMPANY_FORM"]);?>
			<?/*Your login*/?>
			<?= ShowText("SIMPLE_QUESTION_993","LOGIN", $arResult["COMPANY_FORM"], "require login");?>
			<?/*Area of the business*/?>
			<?= ShowDropDown("SIMPLE_QUESTION_284","AREA_OF_BUSINESS", $arResult["COMPANY_FORM"]);?>
			<?/*Official adress*/?>
			<?= ShowText("SIMPLE_QUESTION_295","ADDRESS", $arResult["COMPANY_FORM"], "require");?>
			<?/*City*/?>
			<?= ShowText("SIMPLE_QUESTION_320","CITY", $arResult["COMPANY_FORM"], "require");?>
			<?/*Country*/?>
			<?= ShowText("SIMPLE_QUESTION_778","COUNTRY", $arResult["COMPANY_FORM"], "require");?>
			<?/*http://*/?>
		...
		<div class="block-participant">
			...
			<?= ShowText("SIMPLE_QUESTION_446","NAME", $arResult["PARTICIPANT_FORM"], "require");?>
			<?/*Participant last name*/?>
			<?= ShowText("SIMPLE_QUESTION_551","LAST_NAME", $arResult["PARTICIPANT_FORM"], "require");?>
			<?/*Salutation*/?>
			<?= ShowDropDown("SIMPLE_QUESTION_889","SALUTATION", $arResult["PARTICIPANT_FORM"]);?>
			<?/*Job title*/?>
			<?= ShowText("SIMPLE_QUESTION_729","JOB_POST", $arResult["PARTICIPANT_FORM"], "require");?>
			<?/*Telephone*/?>
