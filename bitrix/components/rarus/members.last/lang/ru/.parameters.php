...
$MESS ['T_IBLOCK_DESC_LIST_CONT'] = "Количество участников на странице";
...
$MESS ['T_IBLOCK_DESC_USER_GROUPS'] = "Группы пользователей";
$MESS ['MEMB_COMPANY_NAME_ID'] = "ID Поля «Имя компании»";
$MESS ['MEMB_LOGIN_ID'] = "ID Поля «Логин»";
$MESS ['MEMB_URL_TEMPLATE'] = "Адрес детальной страницы";
?>