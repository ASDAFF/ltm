...
$APPLICATION->SetTitle("Фотографии LTM 2009");
?><h1>Фотографии LTM 2009</h1>
    ...
    <select onchange="location.href = this.options[this.selectedIndex].value;">
        ...
        <option value="#" selected>2009</option>
        <option value="/ru/photo/2008/">2008</option>
        <option value="/ru/photo/">2007</option>
    </select>
    </p>
