...
<? if($_SERVER["REQUEST_METHOD"] == "POST" && "Y" == $exhParticipantEdit)
{
	...
	//получение старого описани€ компании
	...
	if(isset($_POST["PHOTO"]))
	{
		...
		foreach ($_POST["PHOTO"] as $path)
		{
			...
			$arFields = array(
				...
				"IBLOCK_ID"      => PHOTO_GALLERY_ID,//галере€
				"NAME"           => "‘ото " . (++$photoCount),
				"ACTIVE"         => "Y",            // активен
	...
	//отправка почтового сообщени€ администратору
...
if("Y" != $exhParticipantEdit)
{
    ...
    //выборка данных дл€ вывода в форме
...
<div class="create-page">
	...
	<?=bitrix_sessid_post()?>
		...
		<div class="description">
			...
			<div class="title">	Please upload a minimum of 6 (maximum 12) photos of your company/hotel. The maximum size of each photo is 3mb. DonТt forget &mdash; the better the quality of your photos, the better the impression of your company/hotel.</div>
