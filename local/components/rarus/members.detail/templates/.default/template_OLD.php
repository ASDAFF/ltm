    ...
    <div class="text-block">
        <div class="text-block-left">
            ...
            <?if($arResult["SITE_URL"]):?>
                <span class="company-info"><a href="<?=substr($arResult["SITE_URL"], 0 , 4) == "http" ? $arResult["SITE_URL"] : "http://" . $arResult["SITE_URL"] ?>" title="<?=$arResult["NAME"]?>"><?=$arResult["SITE_URL"]?></a></span>
            <?endif?>
        </div>
