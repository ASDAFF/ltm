...
if(empty($arAnswers)) {
	...
	$formFields = [
		...
		"SIMPLE_QUESTION_367", "SIMPLE_QUESTION_482", "SALUTATION_1", "SIMPLE_QUESTION_187",
		"SIMPLE_QUESTION_225", "SIMPLE_QUESTION_770", "SALUTATION_2", "SIMPLE_QUESTION_280",
		"SIMPLE_QUESTION_765", "SIMPLE_QUESTION_627", "SALUTATION_3", "SIMPLE_QUESTION_788",
	];
