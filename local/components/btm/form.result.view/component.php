...
if (CModule::IncludeModule("form"))
{
	...
	if (strlen($arResult["ERROR"]) <= 0)
	{
		...
		if((strlen($arResult["RESULT"]["select_choose_ans"]["ANSWER_VALUE"][0]["USER_TEXT"]) > 0) || (strlen($arResult["RESULT"]["select_choose_ans"]["ANSWER_VALUE"][0]["ANSWER_TEXT"])>0)){
			if(strlen($arResult["RESULT"]["select_choose_ans"]["ANSWER_VALUE"][0]["USER_TEXT"]) > 0){
				$arResult["RESULT"]["select_choose"]["ANSWER_VALUE"][0]["ANSWER_TEXT"] = $arResult["RESULT"]["select_choose_ans"]["ANSWER_VALUE"][0]["USER_TEXT"];
			}
			else{
				$arResult["RESULT"]["select_choose"]["ANSWER_VALUE"][0]["ANSWER_TEXT"] = $arResult["RESULT"]["select_choose_ans"]["ANSWER_VALUE"][0]["ANSWER_TEXT"];
			}
		}
