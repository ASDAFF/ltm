...
$MESS ['COMP_FORM_PARAMS_EMAIL_FIELD'] = "Email field for login";
$MESS ['COMP_FORM_PARAMS_ANKETA_TO'] = "field name for writing this form id";
$MESS ['COMP_FORM_PARAMS_ANKETA_FROM'] = "field name for getting values.";
?>