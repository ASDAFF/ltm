...
class CFormMatrix
{
	...
	static $arExelGuestField = array(
		"NAMES" => array(
			...
			"6" => "Моб. телефон",
			"7" => "Skype",
			"8" => "Имя коллеги (на утро)",
			"9" => "Фамилия коллеги (на утро)",
			"10" => "Должность коллеги (на утро)",
			"11" => "E-mail коллеги (на утро)",
			"12" => "Адрес",
			"13" => "Город",
			"14" => "Страна",
			"15" => "Страна (other)",
			"16" => "Индекс",
			"17" => "Описание компании",
			"18" => "Вид деятельности",
		...
		"QUEST_CODE" => array(
			...
			"3" => "SIMPLE_QUESTION_391",
			"4" => "SIMPLE_QUESTION_373",
			"5" => "SIMPLE_QUESTION_636",
			"6" => "SIMPLE_QUESTION_844",
			"7" => "SIMPLE_QUESTION_111",
			"8" => "SIMPLE_QUESTION_816",
			"9" => "SIMPLE_QUESTION_596",
			"10" => "SIMPLE_QUESTION_304",
			"11" => "SIMPLE_QUESTION_278",
			"12" => "SIMPLE_QUESTION_773",
			"13" => "SIMPLE_QUESTION_672",
			"14" => "SIMPLE_QUESTION_678",
			"15" => "SIMPLE_QUESTION_243",
			"16" => "SIMPLE_QUESTION_756",
			"17" => "SIMPLE_QUESTION_166",
			"18" => "SIMPLE_QUESTION_677",
	...
	static $arExelEvGuestField = array(
		"NAMES" => array(
			...
			"8" => "Имя коллеги 1",
			"9" => "Фамилия коллеги 1",
			"10" => "Должность коллеги 1",
			"11" => "E-mail коллеги 1",
			"12" => "Имя коллеги 2",
			"13" => "Фамилия коллеги 2",
			"14" => "Должность коллеги 2",
			"15" => "E-mail коллеги 2",
			"16" => "Имя коллеги 3",
			"17" => "Фамилия коллеги 3",
			"18" => "Должность коллеги 3",
			"19" => "E-mail коллеги 3",
			"20" => "Адрес",
			"21" => "Город",
			"22" => "Страна",
			...
			"24" => "Индекс",
			"25" => "Вид деятельности",
			"26" => "Web-site компании",
		),
		"QUEST_CODE" => array(
			"0" => "SIMPLE_QUESTION_115", //назв комп
			"1" => "SIMPLE_QUESTION_750", //Имя
			"2" => "SIMPLE_QUESTION_823", //Фамилия
			"3" => "SIMPLE_QUESTION_391", //Должность
			"4" => "SIMPLE_QUESTION_373", //E-mail
			"5" => "SIMPLE_QUESTION_636", //Телефон
			"6" => "SIMPLE_QUESTION_844", //Мобильный телефон
			"7" => "SIMPLE_QUESTION_111", //Skype
			"8" => "SIMPLE_QUESTION_367", //Имя коллеги 1
			"9" => "SIMPLE_QUESTION_482", //Фамилия коллеги 1
			"10" => "SIMPLE_QUESTION_187", //Должность коллеги 1
			"11" => "SIMPLE_QUESTION_421", //E-mail коллеги 1
			"12" => "SIMPLE_QUESTION_225", //Имя коллеги 2
			"13" => "SIMPLE_QUESTION_770", //Фамилия коллеги 2
			"14" => "SIMPLE_QUESTION_280", //Должность коллеги 2
			"15" => "SIMPLE_QUESTION_384", //E-mail коллеги 2
			"16" => "SIMPLE_QUESTION_765", //Имя коллеги 3
			"17" => "SIMPLE_QUESTION_627", //Фамилия коллеги 3
			"18" => "SIMPLE_QUESTION_788", //Должность коллеги 3
			"19" => "SIMPLE_QUESTION_230", //E-mail коллеги 3
			"20" => "SIMPLE_QUESTION_773", //факт адр
			"21" => "SIMPLE_QUESTION_672", //город
			"22" => "SIMPLE_QUESTION_678", //страна
			"23" => "SIMPLE_QUESTION_243", //Страна (other)
			"24" => "SIMPLE_QUESTION_756", //индекс
			"25" => "SIMPLE_QUESTION_677", //вид деят
			"26" => "SIMPLE_QUESTION_552", //http://
		),
		"ANS_TYPE" => array(
			"0" => "USER_TEXT",
			"1" => "USER_TEXT",
